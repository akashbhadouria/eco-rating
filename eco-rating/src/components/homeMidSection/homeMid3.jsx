  ...
  return (
    <div className="containerMid3">
      <div className="textContainerMid3">
        <h1>Our Clients</h1>
        <p>
          At EcoRatings, we believe in knowing the sustainability impact of
          every product and
          <br /> service.
        </p>
      </div>
        ...
        <div className="boxMid3">
          <div className="colMid3">
            ...
            <div>
              ...
              <div className="divLi">
                <li>
                  Grow your style - renewable bamboo fights climate change with
                  every stand.
                </li>
                <li>
                  Our bamboo comes from responsibly managed forests, supporting
